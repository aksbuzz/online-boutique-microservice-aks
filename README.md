...
Services will be available at `localhost:5001` (cart), `localhost:5002` (catalog), `localhost:5003` (email), `localhost:5004` (shipping), `localhost:5005` (currency), `localhost:5006` (payment), `localhost:5008` (checout) and `localhost:5007` (recommendation).
